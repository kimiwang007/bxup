...
<body>
	<div class="container" style="width:100%;">
        ...
        <div class="col-xs-12">        
			<input type="button"  class="btn btn-primary" value="新建知道" onclick="javascript:window.location.href='./subscribeAdd/known'"/>
						...
						<tr>
							...
							<td>
								<c:if test="${item.shelves == 1}">
									<input type="button"  class="btn btn-primary" onclick="javascript:window.location.href='known/known_shelves/${item.id}'" value="上架">
								</c:if>
								<c:if test="${item.shelves == -1}">
									<input type="button"  class="btn btn-danger" onclick="javascript:window.location.href='known/known_shelves/${item.id}'" value="下架">
								</c:if>
							</td>
							<td>
								<input type="button"  class="btn btn-primary" onclick="javascript:window.location.href='known/known_edit/${item.id}'" value="编辑">
