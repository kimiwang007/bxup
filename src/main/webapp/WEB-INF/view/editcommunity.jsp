...
<title>editcommunity.jsp</title>
</head>	
<h2>编辑社区</h2>	
<body>
<form enctype="multipart/form-data" action="community" method="post">
		<table>	
           ...
           <br> <input type="submit" value="保存" onclick="return onSubmit('Save');" class="input">
             	<input type="button"  class="blue_btn" value="返回" onclick="javascript:window.location.href='<%=basePath%>community'"/>	
</form>    
</body>
